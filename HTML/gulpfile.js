...
gulp.task("sprite", function (done) {
  const spriteData = gulp.src("./app/assets/img/sprites/*.*").pipe(
    spritesmith({
...
gulp.task("watch", function () {
  gulp
    .watch("app/assets/img/sprites/*.*", gulp.series("sprite"))
...
gulp.task(
  "default",
  gulp.series("sass", "sprite", gulp.parallel("browserSync", "watch"))
);

gulp.task(
  "build",
  gulp.parallel("clean:dist", "sass", "useref", "img", "css", "fonts")
);

gulp.task(
  "run",
  gulp.series("install", function (done) {
    done();
  })
);
